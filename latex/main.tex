...
\ppsupervisor{dr inż. dr inż. Michał Kalewski}
\ppyear{2025}
...
% \input{chapters/02-przeglad-literatury}
% \input{chapters/03-metodyka}
\input{chapters/05b-instagram}
\input{chapters/05c-facebook}
\input{chapters/05d-merged}
% \input{chapters/05a-pierwsze-badania}
\input{chapters/06-eksperymenty-wyniki}
