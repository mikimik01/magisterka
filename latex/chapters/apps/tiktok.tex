...
(\textbf{RX $\approx$ 123.71 MiB}, \textbf{TX $\approx$ 1.59 MiB}).
...
Wolumen dominuje \textbf{QUIC/HTTP/3} (media po UDP/443); dodatkowo widoczne są \textbf{HTTPS}/TCP dla API oraz standardowe \textbf{DNS}. Brak jawnego HTTP.
...
\begin{itemize}
  \item \textbf{Dominacja HTTP/3/QUIC} — strumienie wideo po UDP/443; niskie RTT ustanawiania i dobra tolerancja strat.
  \item \textbf{Asymetria RX/TX} — silna przewaga danych odbieranych, zgodna z autoplay/scroll feedu.
