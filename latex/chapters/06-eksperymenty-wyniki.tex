...
(ii) wzorców zachowania (bursty podczas interakcji vs.\ aktywność w tle),
...
Zgodnie z metodyką, jedna iteracja (≈ 30–34 min) składa się z: 
\begin{enumerate}
  ...
  \item \textbf{Logowanie (3 min, jeśli dotyczy)} – ścieżki auth/token.
  \item \textbf{Nawigacja (5 min)} – główne ekrany (feed, profil, wyszukiwarka).
  \item \textbf{Media/operacja (3 min)} – krótkie odtwarzanie/przewijanie, wymuszenie większych transferów.
  \item \textbf{Offline/online (4 min)} – 2 min offline + 2 min po reconnect; obserwacja retry/backoff.
  \item \textbf{Zamknięcie (1 min)} – wylogowanie/zamknięcie.
  \item \textbf{Tło (15 min)} – 5 min tuż po zejściu do tła + 10 min dalszej obserwacji.
\end{enumerate}
...
Eksperyment wykonano w dniu 2025-08-18 w oknie \textbf{17{:}56{:}33–18{:}10{:}14} (≈ \SI{13.7}{\minute}). Zarejestrowano \textbf{302} przepływy (\emph{flows}) o łącznym wolumenie \textbf{≈\,28.0 MiB}; \textbf{RX ≈\,27.2 MiB}, \textbf{TX ≈\,0.85 MiB}.
